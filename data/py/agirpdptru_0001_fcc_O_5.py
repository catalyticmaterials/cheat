...
calc = GPAW(mode=PW(400), kpts=(4, 4, 1), xc='RPBE', txt='../txt/agirpdptru_0001_fcc_O_5.txt')
atoms.set_calculator(calc)
dyn = QuasiNewton(atoms, trajectory='../traj/agirpdptru_0001_fcc_O_5.traj')
dyn.run(fmax = 1.0)
atoms.get_potential_energy()
connect('../agirpdptru_fcc_O.db').write(atoms, slabId=1, adsId=5)
