...
calc = GPAW(mode=PW(400), kpts=(4, 4, 1), xc='RPBE', txt='../txt/agirpdptru_0000_ontop_OH_7.txt')
atoms.set_calculator(calc)
dyn = QuasiNewton(atoms, trajectory='../traj/agirpdptru_0000_ontop_OH_7.traj')
dyn.run(fmax = 1.0)
atoms.get_potential_energy()
connect('../agirpdptru_ontop_OH.db').write(atoms, slabId=0, adsId=7)
