...
db = ase.db.connect('relaxations/initial_structures.db') # initialize ASE database
...
config = generate_yml_config(checkpoint_path, 'configs/relax.yml',
                   ...
                   update={'dataset.relax.format': 'ase_db',
                           'dataset.relax.src': 'relaxations/initial_structures.db',
                           'task.write_pos': 'True',
                           ...
                           'task.relax_opt.traj_dir': 'relaxations/',
