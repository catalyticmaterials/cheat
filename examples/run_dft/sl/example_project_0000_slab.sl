...
#SBATCH --job-name=example_project_0000_slab
...
#SBATCH --nice=0
#SBATCH --error='../err/example_project_0000_slab.err'
#SBATCH --output='../log/example_project_0000_slab.log'
module purge
...
mpirun gpaw python ../py/example_project_0000_slab.py