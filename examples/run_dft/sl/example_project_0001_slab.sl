...
#SBATCH --job-name=example_project_0001_slab
...
#SBATCH --nice=0
#SBATCH --error='../err/example_project_0001_slab.err'
#SBATCH --output='../log/example_project_0001_slab.log'
module purge
...
mpirun gpaw python ../py/example_project_0001_slab.py